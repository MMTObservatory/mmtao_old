...
###################################
#
# Request DServ to stop the PCR WFSC Client
#
# Written  14aug06  Started with pcr_wfsc_connect.tcl
#

proc pcr_wfsc_stop { parent_win } {
...
#	}
#    }
    set status [catch { PCR_Cmd WFSC_Stop } msg ]
