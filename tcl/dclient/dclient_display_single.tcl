...
proc dclient_display_single { name init_display realtime parent_win } {
...
#
	...
	after $rate dclient_display_single $name $init_display $realtime $parent_win
    }
